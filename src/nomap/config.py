...
JSONL_PATH      = os.getenv("JSONL_PATH", "data/kb.jsonl")  

# --- Embedding Model Configuration (remote) ---
...
# --- OpenAI-Compatible API Configuration (generator) ---
...
GENERATOR_API_KEY  = os.getenv("GENERATOR_API_KEY", "nokey") 

# --- Reranker Configuration (optional local cross-encoder) ---
RERANKER_MODEL  = os.getenv("RERANKER_MODEL", "cross-encoder/ms-marco-MiniLM-L-6-v2")

# --- Chroma collection ---
COLLECTION_NAME = os.getenv("COLLECTION_NAME", "nomap")
